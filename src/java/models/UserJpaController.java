...
public class UserJpaController implements Serializable {
    ...
    public void create(User user) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            em.persist(user);
            if (userAccount != null) {
                User oldUserOfUserAccount = userAccount.getUser();
                if (oldUserOfUserAccount != null) {
                    oldUserOfUserAccount.setUserAccount(null);
                    oldUserOfUserAccount = em.merge(oldUserOfUserAccount);
                }
